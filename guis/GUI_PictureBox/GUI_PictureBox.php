...
class GUI_PictureBox extends GUI_Module
{
    ...
    {
        $baseDirectory = $this->getVar('baseDirectory');
        $fileName = $this->getVar('fileName');
        $this->filePath = addEndingSlash(DIR_RELATIVE_DATA_ROOT) . addEndingSlash($baseDirectory) . $fileName;
    ...
    protected function prepare(): void
    {
        ...
        $this->setClientVar('imagePath', $this->filePath);
